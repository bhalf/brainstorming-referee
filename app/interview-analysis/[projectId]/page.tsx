...
import ReportView from '@/components/interview-analysis/ReportView';

type Tab = 'upload' | 'guide' | 'matrix' | 'coding' | 'heatmap' | 'comparison' | 'groups' | 'dashboard' | 'report' | 'chat';
...
export default function ProjectDetailPage() {
  ...
  const tabs = [
    ...
    ...(hasAnswers ? [
      ...
      { key: 'report' as Tab, label: t('tab_report', lang), count: 0, icon: (
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
          <polyline points="14 2 14 8 20 8" />
