...
Hier setzt diese Arbeit an. Es geht nicht darum, KI als die bessere Ideenmaschine zu verkaufen oder menschliche Kreativität überflüssig zu machen. Die Frage ist eine andere: Kann KI den Brainstorming-Prozess selbst verbessern — indem sie genau jene gruppendynamischen Ineffizienzen adressiert, die in der Forschung seit Jahrzehnten beschrieben werden? Nicht die Ideen stehen im Mittelpunkt, sondern die Rolle der KI im Ablauf. Wie verändert sich der Verlauf einer Sitzung, wenn ein System mitläuft, das Muster erkennt und gezielt eingreift? Und wie nehmen die Beteiligten das wahr?

Untersucht wird das an Dreiergruppen in einem informellen Setting — der Art von Situation, die im universitären Alltag oder in projektbasierten Teams ständig vorkommt. Kein Moderator, keine feste Struktur, jeder gleichermassen verantwortlich für Inhalt und Prozess. Genau das macht diese Settings anfällig für die beschriebenen Einschränkungen. Und genau deshalb eignen sie sich, um zu prüfen, ob KI hier einen Unterschied machen kann, ohne dass es professionelle Moderation oder aufwendige Vorbereitung braucht.

Methodisch verbindet die Arbeit zwei Stränge. Zunächst liefert ein szenariobasierter Ansatz den konzeptionellen Rahmen: Ein Problemszenario veranschaulicht die typischen Dynamiken informeller Brainstorming-Sitzungen, zwei Interventionsszenarien beschreiben unterschiedliche KI-Rollen — einmal als rein prozeduraler Moderator, einmal ergänzt um gezielte inhaltliche Impulse. Daraus entsteht ein Prototyp. Die empirische Prüfung erfolgt dann über ein Within-Subject-Experiment: Jede Gruppe durchläuft zwei Sitzungen, eine mit und eine ohne KI-Unterstützung. So lassen sich Unterschiede im Prozess, in der Beteiligungsverteilung und in der subjektiven Wahrnehmung direkt vergleichen — bei kontrollierter Gruppenzusammensetzung.
